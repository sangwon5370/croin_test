...
class AlarmTable(QTableWidget):
    ...
    def __init__(self, parent):
        ...
        # 테이블 셋업
        col_info = [('비정상 절차서', 205), ('진단 확률', 175), ('증상만족 여부', 100)]  # (name,width)
...
class MyApp(QWidget):
    def __init__(self, parent=None):
        ...
        symptom_check2 = MyLabel(self, txt_name=f'{symptom_ok}/{symptom_all}')
        symptom_check3 = MyLabel(self, txt_name=f'{symptom_ok}/{symptom_all}')
        symptom_check4 = MyLabel(self, txt_name=f'{symptom_ok}/{symptom_all}')
        ...
        alarmtable.setCellWidget(0, 1, dig_percent_btn1)
        alarmtable.setCellWidget(1, 1, dig_percent_btn2)
        alarmtable.setCellWidget(2, 1, dig_percent_btn3)
        alarmtable.setCellWidget(3, 1, dig_percent_btn4)
